...
kenzo.visuals       = {
    ...
    keybinds        = {
        ...
        ref_list    = { {ui.reference("rage", "aimbot", "double tap")}, {ui.reference("aa", "other", "on shot anti-aim")}, {ui.reference("rage", "other", "quick peek assist")}, ui.reference("rage", "aimbot", "force body aim"), ui.reference("rage", "aimbot", "force safe point"), ui.reference("rage", "other", "duck peek assist"), {ui.reference("aa", "anti-aimbot angles", "freestanding")}, {ui.reference("misc", "miscellaneous", "ping spike")} },
...
kenzo.refs.rage.force_bodyaim                                   = ui.reference("RAGE", "Aimbot", "Force body aim")
kenzo.refs.rage.prefer_bodyaim                                  = ui.reference("RAGE", "Aimbot", "Prefer body aim")
